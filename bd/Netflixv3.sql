...
CREATE TABLE `rel_movies_actors` (
  `idRelMA` int NOT NULL AUTO_INCREMENT,
  `fkMovies` int DEFAULT NULL,
  `fkActors` int DEFAULT NULL,
  PRIMARY KEY (`idRelMA`),
  KEY `fkMovies` (`fkMovies`),
  KEY `fkActors` (`fkActors`),
  CONSTRAINT `rel_movies_actors_ibfk_1` FOREIGN KEY (`fkMovies`) REFERENCES `movies` (`id`),
  CONSTRAINT `rel_movies_actors_ibfk_2` FOREIGN KEY (`fkActors`) REFERENCES `actors` (`idActor`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_movies_users` (
  `idRelMU` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `rel_movies_users_ibfk_2` FOREIGN KEY (`fkMovies`) REFERENCES `movies` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-29 11:07:30
